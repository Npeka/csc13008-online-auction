...
import { ArrowRight, LayoutDashboard, Package, Plus, Zap } from "lucide-react";
...
export function HeroSection({
    ...
    if (isAuthenticated && user?.role === "SELLER") {
      return (
        <div className="text-white">
          ...
          >
            Track your listings, manage bids, and grow your business with our
          ...
          <div className="mt-12 flex gap-8 border-t border-white/20 pt-8">
            <div>
              ...
              <p className="text-sm text-white/70">Total Auctions</p>
            </div>
            <div>
      ...
      return (
        <div className="text-white">
          ...
          <p
            ...
            style={{ maxWidth: "36rem" }}
          >
            Explore unique items, place your bids, and track your wins. Upgrade
            to become a seller anytime.
          </p>
          <div className="flex flex-wrap gap-4">
            <Link to="/products">
              <Button
    ...
    return (
      <div className="text-white">
        ...
        <p
          ...
          style={{ maxWidth: "36rem" }}
        >
          The premier marketplace for online auctions. Bid on quality products
  ...
  return (
    <section className="relative overflow-hidden bg-linear-to-br from-teal-500 via-emerald-400 to-cyan-500 dark:from-emerald-800 dark:via-emerald-700 dark:to-slate-800">
      ...
      <div className="container-app relative py-16 lg:py-18">
