  ...
  return (
    <div className="w-full px-4" style={{ maxWidth: "32rem" }}>
      ...
      <div className="rounded-2xl border border-border bg-bg-card p-8 shadow-lg">
        ...
        <div className="mb-6 rounded-lg bg-bg-secondary p-4 text-sm">
          <p className="mb-2 font-medium text-text">Demo Accounts:</p>
          <ul className="space-y-1 text-text-muted">
            <li>
              <code>admin@morphee.com</code> / <code>admin123</code>
            </li>
            <li>
              <code>breeder@morphee.com</code> / <code>breeder123</code>
            </li>
            <li>
              <code>buyer@morphee.com</code> / <code>buyer123</code>
            </li>
          </ul>
        </div>
